 ...
 * @return OK     - success
 */
static int assert_rbounds(CTCStatics_t *s, int crwb,
 ...
 * @return OK     - success
 */
static int assert_wbounds(CTCStatics_t *s, int crwb,
			  char **uaddr, int size, char **back)
{
#ifdef __Lynx__
	if (crwb) {
 ...
 * @return OK     - success
 */
static int end_read(CTCStatics_t *s, char *kaddr,
		    int size, char *uaddr)
{
	int cc = OK;
#ifdef __linux__
 ...
 * @return OK
 */
static int end_write(CTCStatics_t *s, char *kaddr)
{
#ifdef __linux__
	sysfree(kaddr, 0);
#endif
...
int get_##_blk_idx##_##_r_nm(register CTCStatics_t *s, char *ioctlarg, \
			     int crwb, int r_rw)			\
{									\
...
int get_##_blk_idx##_##_r_nm(register CTCStatics_t *s,		\
...
int set_##_blk_idx##_##_r_nm(register CTCStatics_t *s,		\
			     char *ioctlarg, int crwb, int r_rw)	\
{									\
 ...
 * @return OK     - otherwise
 */
int get___SRV__DEBUG_FLAG(register CTCStatics_t *s,
 ...
 * @return OK     - otherwise
 */
int set___SRV__DEBUG_FLAG(register CTCStatics_t *s,
			  char *uaddr, int crwb, int r_rw)
{
	char *uaddr_back; /* backup user-space address */
 ...
 * @return OK     - otherwise
 */
int get___SRV__DEVINFO_T(register CTCStatics_t *s,
			 char *uaddr, int crwb, int r_rw)
{
	char *uaddr_back; /* backup user-space address */
 ...
 * @return OK     - otherwise
 */
int get___SRV__DRVR_VERS(register CTCStatics_t *s,
			 char *ioctlarg, int crwb, int r_rw)
{
 ...
 * @return OK     - otherwise
 */
int get___SRV__DAL_CONSISTENT(register CTCStatics_t *s,
			      char *uaddr, int crwb, int r_rw)
{
	char *uaddr_back; /* backup user-space address */
	...
	*(unsigned long*)uaddr = CTC_GENERATION_TIME_HEX;
